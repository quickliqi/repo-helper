...
import { ScrapedDeal, IntegrityReport, FieldIssue } from '../../types/scraper-audit-types';
...
export function runIntegrityCheck(deals: ScrapedDeal[]): IntegrityReport[] {
    ...
    deals.forEach((deal, index) => {
        ...
        // ARV vs asking price check (ARV should generally be > asking for investment deals)
