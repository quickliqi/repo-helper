            ...
            <CardContent className="prose prose-sm dark:prose-invert max-w-none pt-6 space-y-6">
              <section>
                ...
                <p className="text-muted-foreground">
                  QuickLiqi ("we," "our," or "us") is committed to protecting your privacy. This Privacy
              ...
              <section>
                ...
                <p className="text-muted-foreground mt-2">
                  To exercise these rights, please contact us at quickliqi@realquickliqi.com.
                </p>
              </section>
              ...
              <section>
                ...
                <ul className="list-none text-muted-foreground mt-2 space-y-1">
                  <li>Email: quickliqi@realquickliqi.com</li>
