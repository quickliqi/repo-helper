import { z } from 'zod';
import { DealMetrics } from './deal-types';
...
// ─── Validated deal (with calculator metrics) ──────────────────────
export interface ValidatedDeal extends ScrapedDeal {
    metrics: DealMetrics | null;
    validated: boolean;
    calculatorConfidence: number; // 0-100
}
